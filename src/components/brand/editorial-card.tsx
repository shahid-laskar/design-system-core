  ...
  return (
    <article className="group grid min-w-0 gap-5 sm:grid-cols-[1.1fr_1fr] sm:items-center">
      <div className="media-frame aspect-[16/11]">
        <img src={image} alt={imageAlt} width={1600} height={1104} loading="lazy" className="size-full object-cover transition-transform duration-brand-slow ease-brand group-hover:scale-[1.02]" />
      </div>
      <div>
        <div className="eyebrow flex items-center gap-3 text-muted-foreground">
